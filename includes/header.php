...
<body>
  <header>
    <div class="top">
      <div class="sidenav">
        <button class="sidenav-btn" id="sidenav-btn">
          <img src="assets/svgs/menu_24dp_1F1F1F_FILL0_wght400_GRAD0_opsz24.png"></img>
        </button>
      </div>
      <div class="topLogo">
        <a href="#">
      ...
      <nav>
        <ul class="nav-list">
          <li><a href="user/login.php">Personal</a></li>
      ...
      <div class="sidenav-container" id="sideNav">
        <ul class="sidenav-list">
          <li><a href="index.php#fibreContainer">Get Connected</a></li>
          <li><a href="index.php#explorePackages">Explore Packages</a></li>
    ...
    <div class="bottom">
      ...
      <nav>
        <ul class="bottom-nav">
          <li><a href="#fibreContainer">Get Connected</a></li>
          <li><a href="#explorePackages">Explore Packages</a></li>
          <li><a href="shop/index.php">Shop</a></li>
